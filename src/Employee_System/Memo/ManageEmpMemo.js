...
export default function ManageEmpMemo() {
  ...
  useEffect(() => {
    ...
    fetch(`https://pjsofttech.in:10443/memos/all?institutecode=${instituteCode}`)
  ...
  const handleUpdateMemo = () => {
    ...
    fetch(`https://pjsofttech.in:10443/memos/updatememo/${selectedMemo.mid}`, {
      method: "PUT",
      headers: {
  ...
  const handleDeleteMemo = () => {
    fetch(`https://pjsofttech.in:10443/memos/deletememo/${confirmDeleteId}`, {
      method: "DELETE",
    })
      .then(() => {
