...
const EmployeeDashboard = () => {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            try {
                const response = await fetch(`http://13.233.43.240:8082/getAllemp?institutecode=${institutecode}`);
                if (!response.ok) {
    ...
    useEffect(() => {
        const apiUrls = {
            'All': `http://13.233.43.240:8082/getAllemp?institutecode=${institutecode}`,
            '7Days': `http://13.233.43.240:8082/employees/last7days?institutecode=${institutecode}`,
            '30Days': `http://13.233.43.240:8082/employees/lastMonth1?institutecode=${institutecode}`,
