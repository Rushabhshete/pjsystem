...
import { Container, TextField, Button, Box, Typography, Grid, InputAdornment, MenuItem, FormControl,   Table,
  TableBody,
  TableCell,
  TableContainer,
  TableHead,
...
function Category() {
  ...
  return (
    ...
    <div className='textField-root' onSubmit={handleSubmittable} style={{marginTop:'10px'}}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sx={{marginLeft:'520px'}}>
        ...
        <Table>
          <TableHead  sx={{ background: '#f2f2f2'}}>
            <TableRow>
              ...
              <TableCell><Typography variant="subtitle2" fontWeight="bold">HRA(%)</Typography></TableCell>
              <TableCell><Typography variant="subtitle2" fontWeight="bold">TA(%)</Typography></TableCell>
              <TableCell><Typography variant="subtitle2" fontWeight="bold">Incentive(%)</Typography></TableCell>
              <TableCell><Typography variant="subtitle2" fontWeight="bold">SPI(%)</Typography></TableCell>
              <TableCell><Typography variant="subtitle2" fontWeight="bold">Medical(%)</Typography></TableCell>
              <TableCell><Typography variant="subtitle2" fontWeight="bold">PF(%)</Typography></TableCell>
              <TableCell><Typography variant="subtitle2" fontWeight="bold">ESF(%)</Typography></TableCell>
              <TableCell><Typography variant="subtitle2" fontWeight="bold">Professional Tax(%)</Typography></TableCell>
              <TableCell><Typography variant="subtitle2" fontWeight="bold">Income Tax(%)</Typography></TableCell>
  ...
  <Grid item>
            <Box display="flex" justifyContent="center" mt={2}>
              <Button color="secondary" variant='contained' onClick={() => setShowUpdateModal(false)} style={{ marginRight: '10px' }}>
                Close
              </Button>
    ...
    >
      Category Information
        ...
        <Modal.Footer>
          <Button color="primary" variant="contained" onClick={() => setShowInfoModal(false)}>
            Close
          </Button>
        </Modal.Footer>
      </Modal>
