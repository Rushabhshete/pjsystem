          ...
          <Table>
            <TableHead sx={{ background: '#f2f2f2' }}>
              <TableRow>
                ...
                <TableCell>HRA Percentage</TableCell>
                <TableCell>TA Percentage</TableCell>
                <TableCell>Incentive Percentage</TableCell>
                <TableCell>SPI Percentage</TableCell>
                <TableCell>Medical Percentage</TableCell>
                <TableCell>PF Percentage</TableCell>
                <TableCell>ESF Percentage</TableCell>
                <TableCell>Professional Tax Percentage</TableCell>
                <TableCell>Income Tax Percentage</TableCell>
            ...
            <TableBody>
              {categories.map(category => (
                <TableRow key={category.id}>
                  ...
                  <TableCell>{category.totalPaidLeave}</TableCell>
                  <TableCell>
                    <IconButton onClick={() => handleInfo(category)}>
                      <Info sx={{ color: 'green' }} />
                    </IconButton>
                    <IconButton onClick={() => {
                      setSelectedCategory(category); 
