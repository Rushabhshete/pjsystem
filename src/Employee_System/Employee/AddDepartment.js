...
//     try {
//       await axios.put(`http://13.233.43.240:8082/departments/updateDepartment/${currentDepartment.id}`, { department: updatedDepartmentName });
...
const Department = () => {
  ...
  const handleAddSubmit = async () => {
    try {
      await axios.post(`http://13.233.43.240:8082/departments/addDepartment?institutecode=${institutecode}`, { department });
      toast.success('Department added successfully');
