...
export default function YearlyGraph() {
  ...
  const fetchData = async (selectedYear) => {
    try {
      const response = await axios.get('https://pjsofttech.in:14443/getYearlyEnquiryCountOfAllMonths', {
        params: {
          year: selectedYear,
  ...
  return (
    <div>
     <Grid container justifyContent="space-evenly"  spacing={2}  className='textField-root'>
     <Grid item>
