...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchIncomeData = async () => {
      try {
        const response = await fetch(
          `http://13.233.43.240:8087/dashboard/incomes/totals?email=${getEmail()}`
        );
    ...
    const fetchExpenseData = async () => {
      try {
        const response = await fetch(
          `http://13.233.43.240:8087/dashboard/expenses/totals?email=${getEmail()}`
        );
        const data = await response.json();
        setExpenseData(data);
      } catch (error) {
    ...
    const fetchSavingsData = async () => {
      try {
        const response = await fetch(
          `http://13.233.43.240:8087/dashboard/savings?email=${getEmail()}`
        );
        const data = await response.json();
        setSavingsData(data);
      } catch (error) {
    ...
    const fetchMonthlyIncome = async () => {
      try {
        const response = await fetch(
          `http://13.233.43.240:8087/income/total-monthly?year=${year}&adminemail=${getEmail()}`
        );
        const data = await response.json();
    ...
    const fetchMonthlyExpense = async () => {
      try {
        const response = await fetch(
          `http://13.233.43.240:8087/expense/total-monthly?year=${year}&adminemail=${getEmail()}`
        );
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchIncomeCategories = async () => {
      try {
        const response = await fetch(
          `http://13.233.43.240:8087/dashboard/incomes?email=${getEmail()}`
        );
        const data = await response.json();
    ...
    const fetchExpenseCategories = async () => {
      try {
        const response = await fetch(
          `http://13.233.43.240:8087/dashboard/expenses?email=${getEmail()}`
        );
        const data = await response.json();
