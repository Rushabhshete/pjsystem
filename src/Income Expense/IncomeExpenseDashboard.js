      ...
      const fetchPendingData = async () => {
        try {
          const [pendingIncomeResponse, pendingExpenseResponse] = await Promise.all([
            fetch(`http://13.233.43.240:8087/dashboard/income/pending?timeframe=today&institutecode=${getInstituteCode()}`),
            fetch(`http://13.233.43.240:8087/dashboard/expense/pending?timeframe=today&institutecode=${getInstituteCode()}`)
          ]);
          
          const incomeStats = {
            today: await pendingIncomeResponse.json(),
            last7Days: await (await fetch(`http://13.233.43.240:8087/dashboard/income/pending?timeframe=last7days&institutecode=${getInstituteCode()}`)).json(),
            last30Days: await (await fetch(`http://13.233.43.240:8087/dashboard/income/pending?timeframe=last30days&institutecode=${getInstituteCode()}`)).json(),
            last365Days: await (await fetch(`http://13.233.43.240:8087/dashboard/income/pending?timeframe=last365days&institutecode=${getInstituteCode()}`)).json(),
            total: await (await fetch(`http://13.233.43.240:8087/dashboard/income/pending?timeframe=total&institutecode=${getInstituteCode()}`)).json(),
          };

          const expenseStats = {
            today: await pendingExpenseResponse.json(),
            last7Days: await (await fetch(`http://13.233.43.240:8087/dashboard/expense/pending?timeframe=last7days&institutecode=${getInstituteCode()}`)).json(),
            last30Days: await (await fetch(`http://13.233.43.240:8087/dashboard/expense/pending?timeframe=last30days&institutecode=${getInstituteCode()}`)).json(),
            last365Days: await (await fetch(`http://13.233.43.240:8087/dashboard/expense/pending?timeframe=last365days&institutecode=${getInstituteCode()}`)).json(),
            total: await (await fetch(`http://13.233.43.240:8087/dashboard/expense/pending?timeframe=total&institutecode=${getInstituteCode()}`)).json(),
          };
