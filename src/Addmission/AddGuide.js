...
const AddGuide = () => {
  ...
  const handleAddGuide = async () => {
    try {
      ...
      await axios.post(
        `https://pjsofttech.in:13443/api/conductBy/saveConductBy?institutecode=${institutecode}`,
        { guideName }
      );
  ...
  //     }
  //     await axios.put(
  //       `https://pjsofttech.in:13443/api/conductBy/updateConductBy/${selectedGuideId}?institutecode=${institutecode}`,
  ...
  const handleDeleteGuide = async () => {
    try {
      await axios.delete(
        `https://pjsofttech.in:13443/api/conductBy/deleteConductBy/${selectedGuideId}`
      );
