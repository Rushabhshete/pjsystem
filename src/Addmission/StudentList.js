...
const StudentList = () => {
        ...
        switch (timeRange) {
          case "Today":
            admissionResponse = await axios.get(
              `https://pjsofttech.in:13443/getAdmissionsByTodayByInstitutecode?institutecode=${institutecode}`
            );
            break;
          case "7Days":
            admissionResponse = await axios.get(
              `https://pjsofttech.in:13443/AdmissionIn7DaysData?institutecode=${institutecode}`
            );
            break;
          case "30Days":
            admissionResponse = await axios.get(
              `https://pjsofttech.in:13443/AdmissionIn30DaysData?institutecode=${institutecode}`
            );
            break;
          case "365Days":
            admissionResponse = await axios.get(
              `https://pjsofttech.in:13443/AdmissionIn365DaysData?institutecode=${institutecode}`
            );
            break;
          case "Custom":
            admissionResponse = await axios.get(
              `https://pjsofttech.in:13443/admissionsBetweenDates?institutecode=${institutecode}&startDate=${startDate}&endDate=${endDate}`
            );
            break;
          default:
            admissionResponse = await axios.get(
              `https://pjsofttech.in:13443/admissions?institutecode=${institutecode}`
            );
            break;
        }
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(
        `https://pjsofttech.in:13443/deleteAdmission/${admissionIdToDelete}`
      );
      setAdmissions((prevAdmissions) =>
